...
public class MessageProvider extends ContentProvider {
	...
	public Uri insert(Uri uri, ContentValues initialValues) {
		...
		String[] str={values.getAsString(ChatContent.Messages._ID),
				      values.getAsString(ChatContent.Messages.SENDER),
				      values.getAsString(ChatContent.Messages.MESSAGE)
		              };
		messages.addRow(str);
		
		OutputStream os = null;
		try {
			os = getContext().openFileOutput(DATABASE_NAME, Context.MODE_PRIVATE);
		} catch (FileNotFoundException e) {
