...
public class PeerInfoProvider extends ContentProvider {
	...
	private static final String DATABASE_NAME = "chat_peer.db";
	...
	public  static class DatabaseHelper extends SQLiteOpenHelper {
		...
		public void onCreate(SQLiteDatabase db) {
			db.execSQL("CREATE TABLE " + PEER_TABLE_NAME + " ("
					...
					+ ChatContent.Peers.CHATROOM + " TEXT"
					+ ");");
		}
	...
	public Uri insert(Uri uri, ContentValues initialValues) {
		...
		if (values.containsKey(ChatContent.Peers.CHATROOM) == false) {
			values.put(ChatContent.Peers.CHATROOM, 0.0);
		}
	...
	static {
		...
		peerProjectionMap.put(ChatContent.Peers.CHATROOM, ChatContent.Peers.CHATROOM);
	}
