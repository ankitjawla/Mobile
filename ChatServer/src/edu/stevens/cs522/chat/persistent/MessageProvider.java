	...
	private MatrixCursor loadMessages() {
		...
		if (messages == null) {
			...
			try {
				...
				Log.i(ChatServer.TAG, "Messages file has not been created yet.");
			} catch (IOException e) {
				Log.e(ChatServer.TAG, "IO error while reading message file");
			}
		}
...
//			os.close();
			...
			Log.e(ChatServer.TAG, "IO error while writing message file");
		}
